...
const Login = () => {
  ...
  return (
    <div className="relative">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.dev/svgjs" width="1920" preserveAspectRatio="none" viewBox="0 0 1440 560">
    <g mask="url(&quot;#SvgjsMask1232&quot;)" fill="none">
        <rect width="1440" height="560" x="0" y="0" fill="url(&quot;#SvgjsLinearGradient1233&quot;)"></rect>
        <path d="M1440 0L1366.02 0L1440 240.93z" fill="rgba(255, 255, 255, .1)"></path>
        <path d="M1366.02 0L1440 240.93L1440 264.85L1153.81 0z" fill="rgba(255, 255, 255, .075)"></path>
        <path d="M1153.81 0L1440 264.85L1440 406.62L1093.79 0z" fill="rgba(255, 255, 255, .05)"></path>
        <path d="M1093.79 0L1440 406.62L1440 468.11L634.01 0z" fill="rgba(255, 255, 255, .025)"></path>
        <path d="M0 560L503.6 560L0 462.29z" fill="rgba(0, 0, 0, .1)"></path>
        <path d="M0 462.29L503.6 560L874.85 560L0 340.62z" fill="rgba(0, 0, 0, .075)"></path>
        <path d="M0 340.62L874.85 560L1064.7 560L0 243.29000000000002z" fill="rgba(0, 0, 0, .05)"></path>
        <path d="M0 243.29000000000002L1064.7 560L1119.3400000000001 560L0 99.93z" fill="rgba(0, 0, 0, .025)"></path>
    </g>
    <defs>
        <mask id="SvgjsMask1232">
            <rect width="1440" height="560" fill="#ffffff"></rect>
        </mask>
        <linearGradient x1="15.28%" y1="-39.29%" x2="84.72%" y2="139.29%" gradientUnits="userSpaceOnUse" id="SvgjsLinearGradient1233">
      ...
      <div className="mx-2 pt-10 md:mx-8 mb-10 font-poppins lg:flex gap-5 rounded-lg">
        ...
        <div className="flex-1 md:px-16 md:py-16">
          ...
          <form onSubmit={handleLogin} className="card-body">
            ...
            <div className="form-control w-full mx-auto">
              <label className="label">
                <span className="label-text text-xl md:text-white">Password</span>
              </label>
              <input
                type="password"
